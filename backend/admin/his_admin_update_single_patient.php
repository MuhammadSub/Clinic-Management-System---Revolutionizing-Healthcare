                                        ...
                                        <form method="post">
											...
											<div class="form-row">
												<div class="form-group col-md-6">
													...
													<input type="date" required="required" value="<?php echo $row->pat_dob;?>" name="pat_dob" class="form-control" id="inputDOB" placeholder="DD/MM/YYYY">
												</div>
												<div class="form-group col-md-6">
													<label for="inputAge" class="col-form-label">Age</label>
													<input required="required" type="number" value="<?php echo $row->pat_age;?>" name="pat_age" class="form-control" id="inputAge" placeholder="Patient's Age">
												</div>
											</div>

											<div class="form-group">
												<label for="inputAddress" class="col-form-label">Address</label>
												<input required="required" type="text" value="<?php echo $row->pat_addr;?>" class="form-control" name="pat_addr" id="inputAddress" placeholder="Patient's Address">
											</div>

											<div class="form-row">
												<div class="form-group col-md-4">
													<label for="inputPhone" class="col-form-label">Mobile Number</label>
													<input required="required" type="tel" pattern="[0-9]{11}" value="<?php echo $row->pat_phone;?>" name="pat_phone" class="form-control" id="inputPhone" placeholder="XXXXXXXXXXX">
												</div>
												<div class="form-group col-md-4">
													<label for="inputAilment" class="col-form-label">Ailment</label>
													<input required="required" type="text" value="<?php echo $row->pat_ailment;?>" name="pat_ailment" class="form-control" id="inputAilment">
												</div>
												<div class="form-group col-md-4">
