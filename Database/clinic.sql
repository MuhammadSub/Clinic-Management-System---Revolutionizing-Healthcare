...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1681949278ltr&server=1">
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en_GB&v=5.1.3"></script>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_docs">`clinic`.`his_docs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_laboratory">`clinic`.`his_laboratory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_admin">`clinic`.`his_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_equipments">`clinic`.`his_equipments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_medical_records">`clinic`.`his_medical_records`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_vendor">`clinic`.`his_vendor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_assets">`clinic`.`his_assets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_accounts">`clinic`.`his_accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_payrolls">`clinic`.`his_payrolls`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=his_pharmaceuticals">`clinic`.`his_pharmaceuticals`</a></li></ul></div><div class="drop_list"><button title="Favourite tables" class="drop_button btn">Favourites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favourite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="36284d58276754777b42645d485c7e7d">
...
<legend>Navigation panel</legend>
    <p>Customise appearance of the navigation panel.</p>
...
<legend>Navigation tree</legend>
    <p>Customise the navigation tree.</p>
<table class="pma-table" width="100%" cellspacing="0">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="clinic" targettable="his_equipments">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `his_equipments`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic" targettable="his_admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `his_admin`</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO his_admin (ad_id, ad_fname, ad_lname, ad_email, ad_pwd)
VALUES (1, &#039;Subhan&#039;, &#039;Ali&#039;, &#039;subhanali@gmail.com&#039;, &#039;subhan&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic" targettable="his_admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `his_admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="clinic" targettable="his_docs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `his_docs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic" targettable="his_admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `his_admin`(`ad_fname`, `ad_lname`, `ad_email`, `ad_pwd`) VALUES (&#039;Subhan&#039;,&#039;Ali&#039;,&#039;subhan@gmail.com&#039;,&#039;bbe4d895eee9d319e5c5cc18f2e389365&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic" targettable="his_admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE DATABASE clinic;</span>
                        </div>
                                            <div class="message history collapsed hide"
            ...
            Queried time
                            ...
                            <span class="query">-- Create table `his_accounts`
  ...
  acc_amount varchar(200) DEFAULT NULL
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `his_docs`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="clinic" targettable="his_laboratory">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `his_laboratory`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic" targettable="his_laboratory">
                            <div class="action_content">
